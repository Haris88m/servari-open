...
"""Quantization tables + VRAM math + the vendored model catalog.

Ported near-verbatim from Odysseus services/hwfit/models.py — the calibrated
QUANT_* tables and the memory estimator are empirical and intentionally
unchanged. Pure stdlib."""
import json
import os
import re
