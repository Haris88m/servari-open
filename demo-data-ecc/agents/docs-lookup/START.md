...
> Consumed from ECC (https://github.com/affaan-m/ECC) under the MIT license.
> consumed_at=2026-06-12 | converter=tools/consume_ecc.py
> source fields: model=sonnet | tools=Read, Grep, mcp__context7__resolve-library-id, mcp__context7__query-docs
